  ...
  return (
    <Grid container direction="column">
      ...
      <Grid
        ...
        className={classes.rowContainer}
        style={{ backgroundColor: "#03475A", height: "90em" }}
      >
        <Grid
          item
          container
      ...
      {/* End Process - Consultation */}

      {/* Start Process - Mockup */}
      <Grid
        item
        container
        direction={matchesMD ? "column" : "row"}
      ...
      {/* End Process - Maintain */}

      {/* Start Process - Iterate */}
      <Grid
        item
        container
        direction={matchesMD ? "column" : "row"}
